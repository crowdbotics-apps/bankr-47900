"""
Django settings for bankr_47900 project.
...
WSGI_APPLICATION = 'bankr_47900.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bankr_47900 API",
    "DESCRIPTION": "API documentation for bankr_47900 App",
    "VERSION": "v1",
}
